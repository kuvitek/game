...
export default class Players extends React.Component {
  ...
  syncData(){
      let myObj = lib.getPlayerNames(this.props.TokenGame);
      if ((this.state.playerNames.owner!=myObj.owner)
         ||(this.state.playerNames.opponent!=myObj.opponent)){
        this.setState({playerNames:myObj});
      }
  };
  render() {
